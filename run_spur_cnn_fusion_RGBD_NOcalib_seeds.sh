#!/bin/bash
#SBATCH --job-name=spur_cnn_fusion_RGBD_NOcalib
#SBATCH --array=1-5
...
# SPUR Variant 2 — full_spur box-family, 5 seeds
#   Model: MVStereoUNet (from-scratch CNN, in_ch=4 = RGB + raw depth)
...
#   Flags: --no_pro_calib (disables loader's alpha*depth+beta step).
...
VARIANT="cnn_fusion_RGBD_NOcalib"
...
# ─────────────────────────────────────────────────────────────────────────────
# Training — MVStereoUNet (CNN) with fusion, RGB+raw PRO (alpha/beta OFF)
# ─────────────────────────────────────────────────────────────────────────────
