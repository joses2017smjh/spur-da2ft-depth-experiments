#!/bin/bash
#SBATCH --job-name=spur_cnn_adaptres_md1_0_calib
#SBATCH --array=1-5
...
#   PRO:    alpha,beta-calibrated PRO (default loader)
#   Head:   2-channel adaptive-residual head, max_delta=1.0 m
...
VARIANT="cnn_adaptres_md1_0_calib"
...
# ─────────────────────────────────────────────────────────────────────────────
# Training — adaptive residual head, max_delta=1.0
# ─────────────────────────────────────────────────────────────────────────────
