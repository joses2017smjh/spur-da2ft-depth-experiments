#!/bin/bash
#SBATCH --job-name=spur_boxlr_D_anchor
#SBATCH --array=1-5
...
# Experiment D - anchor: SiLog(trunk) + lambda*L1(box_only) with lambda=0.2.
# Trunk drives shape; box only anchors absolute distance via L1.
