#!/bin/bash
#SBATCH --job-name=spur_cnn_PROcalib_1pair_rgbD_nofusion
#SBATCH --array=1-5
#SBATCH --partition=gpu,dgx2,ampere,dgxh
#SBATCH --gres=gpu:1
...
# SPUR CNN-fusion ablation with DA2-FINETUNED input depth, full_spur box-family.
#   Model: MVStereoUNet (from-scratch CNN, in_ch=4 = RGB + input depth)
