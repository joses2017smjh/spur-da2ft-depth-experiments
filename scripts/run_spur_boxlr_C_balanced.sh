#!/bin/bash
#SBATCH --job-name=spur_boxlr_C_balanced
#SBATCH --array=1-5
...
# Experiment C - balanced: 0.5*SiLog(trunk) + 0.5*SiLog(box_only), two separate
# SiLog terms with equal weight.
