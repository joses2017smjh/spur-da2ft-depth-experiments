#!/bin/bash
#SBATCH --job-name=spur_cnn_fusion_RGBD_NOcalib_da2ft
#SBATCH --array=1-5
#SBATCH --gres=gpu:1
...
#         DATA_ROOT=/path/to/data sbatch run_spur_cnn_fusion_RGBD_NOcalib_da2ft_seeds.sh
...
VARIANT="cnn_fusion_RGBD_NOcalib_da2ft"
...
# ─────────────────────────────────────────────────────────────────────────────
# Training — MVStereoUNet (CNN) with fusion, RGB + DA2-finetuned depth (no a/b)
# ─────────────────────────────────────────────────────────────────────────────
